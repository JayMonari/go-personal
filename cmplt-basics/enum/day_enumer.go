// Code generated by "enumer -type=Day -trimprefix=Day -json -text -yaml -sql -gqlgen"; DO NOT EDIT.
...
const (
	_DayName_0      = "UnknownSundayMonday"
	_DayLowerName_0 = "unknownsundaymonday"
	_DayName_1      = "Tuesday"
...
var _DayValues = []Day{DayUnknown, DaySunday, DayMonday, DayTuesday, DayWednesday, DayThursday, DayFriday, DaySaturday}

var _DayNameToValueMap = map[string]Day{
	_DayName_0[0:7]:        DayUnknown,
	_DayLowerName_0[0:7]:   DayUnknown,
	_DayName_0[7:13]:       DaySunday,
	_DayLowerName_0[7:13]:  DaySunday,
	_DayName_0[13:19]:      DayMonday,
	_DayLowerName_0[13:19]: DayMonday,
...
// MarshalGQL implements the graphql.Marshaler interface for Day
func (i Day) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(i.String()))
}

// UnmarshalGQL implements the graphql.Unmarshaler interface for Day
func (i *Day) UnmarshalGQL(value interface{}) error {
	str, ok := value.(string)
	if !ok {
		return fmt.Errorf("Day should be a string, got %T", value)
	}
